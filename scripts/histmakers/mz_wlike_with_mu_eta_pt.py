...
def build_graph(df, dataset):
    ...
    if not dataset.is_data and not args.onlyMainHistograms:
        ...
        unc_df = syst_tools.add_muon_efficiency_unc_hists(results, unc_df, muon_efficiency_helper_stat, muon_efficiency_helper_syst, unc_axes, unc_cols, args.uncertainty_hist, , muons=["posMuons", "negMuons"])
